...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LearnerLanguage'
        db.create_table(u'lambada_learnerlanguage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('learner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lambada.UserProfile'])),
            ('language', self.gf('django.db.models.fields.CharField')(default='en', max_length=255)),
        ))
        db.send_create_signal(u'lambada', ['LearnerLanguage'])

        # Adding model 'CoachLanguage'
        db.create_table(u'lambada_coachlanguage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('learner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lambada.UserProfile'])),
            ('language', self.gf('django.db.models.fields.CharField')(default='en', max_length=255)),
        ))
        db.send_create_signal(u'lambada', ['CoachLanguage'])

        # Adding field 'Practice.paid'
        db.add_column(u'lambada_practice', 'paid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'LearnerLanguage'
        db.delete_table(u'lambada_learnerlanguage')

        # Deleting model 'CoachLanguage'
        db.delete_table(u'lambada_coachlanguage')

        # Deleting field 'Practice.paid'
        db.delete_column(u'lambada_practice', 'paid')
    ...
    models = {
        ...
        u'lambada.coachlanguage': {
            'Meta': {'object_name': 'CoachLanguage'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.CharField', [], {'default': "'en'", 'max_length': '255'}),
            'learner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['lambada.UserProfile']"})
        },
        ...
        u'lambada.learnerlanguage': {
            'Meta': {'object_name': 'LearnerLanguage'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.CharField', [], {'default': "'en'", 'max_length': '255'}),
            'learner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['lambada.UserProfile']"})
        },
        ...
        u'lambada.topic': {
            ...
            'total_topic_rating': ('django.db.models.fields.IntegerField', [], {'default': "'0'"})
        },
