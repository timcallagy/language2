...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TopicRating.topic'
        db.add_column(u'lambada_topicrating', 'topic',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['lambada.Topic']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TopicRating.topic'
        db.delete_column(u'lambada_topicrating', 'topic_id')
