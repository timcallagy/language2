...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Channel.pk'
        db.delete_column(u'lambada_channel', 'pk')

        # Adding field 'Channel.practice_pk'
        db.add_column(u'lambada_channel', 'practice_pk',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Channel.pk'
        db.add_column(u'lambada_channel', 'pk',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Channel.practice_pk'
        db.delete_column(u'lambada_channel', 'practice_pk')
    ...
    models = {
        ...
        u'lambada.topic': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 24, 0, 0)'}),
