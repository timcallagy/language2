...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'lambada.correctionrecording': {
            'Meta': {'object_name': 'CorrectionRecording'},
            'correctionRec': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'error': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['lambada.SpeakingError']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'lambada.practice': {
