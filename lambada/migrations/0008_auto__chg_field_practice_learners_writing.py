...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Practice.learners_writing'
        db.alter_column(u'lambada_practice', 'learners_writing', self.gf('tinymce.models.HTMLField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Practice.learners_writing'
        db.alter_column(u'lambada_practice', 'learners_writing', self.gf('tinymce.models.HTMLField')())
