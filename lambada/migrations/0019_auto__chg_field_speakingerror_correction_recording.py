...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'lambada_speakingerror', 'correction_recording', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'SpeakingError.correction_recording'
        db.alter_column(u'lambada_speakingerror', 'correction_recording', self.gf('django.db.models.fields.files.FileField')(default=datetime.datetime(2014, 8, 23, 0, 0), max_length=100))
