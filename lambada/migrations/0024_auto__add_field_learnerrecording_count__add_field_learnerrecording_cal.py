...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LearnerRecording.count'
        db.add_column(u'lambada_learnerrecording', 'count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'LearnerRecording.call_start_time'
        db.add_column(u'lambada_learnerrecording', 'call_start_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LearnerRecording.count'
        db.delete_column(u'lambada_learnerrecording', 'count')

        # Deleting field 'LearnerRecording.call_start_time'
        db.delete_column(u'lambada_learnerrecording', 'call_start_time')
