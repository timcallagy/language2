...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ChannelPrivate'
        db.create_table(u'lambada_channelprivate', (
        ...
        db.send_create_signal(u'lambada', ['ChannelPrivate'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ChannelPrivate'
        db.delete_table(u'lambada_channelprivate')
    ...
    models = {
        ...
        u'lambada.topic': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 19, 0, 0)'}),
