...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Practice.coach'
        db.add_column(u'lambada_practice', 'coach',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Recording.blob'
        db.delete_column(u'lambada_recording', 'blob')


    def backwards(self, orm):
        # Deleting field 'Practice.coach'
        db.delete_column(u'lambada_practice', 'coach')

        # Adding field 'Recording.blob'
        db.add_column(u'lambada_recording', 'blob',
                      self.gf('django.db.models.fields.BinaryField')(default=datetime.datetime(2014, 7, 23, 0, 0), blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'lambada.topic': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 23, 0, 0)'}),
