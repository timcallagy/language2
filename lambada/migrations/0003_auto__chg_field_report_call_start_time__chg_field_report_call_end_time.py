...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Report.call_start_time'
        db.alter_column(u'lambada_report', 'call_start_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Report.call_end_time'
        db.alter_column(u'lambada_report', 'call_end_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Report.call_start_time'
        db.alter_column(u'lambada_report', 'call_start_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 7, 29, 0, 0)))

        # Changing field 'Report.call_end_time'
        db.alter_column(u'lambada_report', 'call_end_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 7, 29, 0, 0)))
