...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SpeakingError.error_time'
        db.delete_column(u'lambada_speakingerror', 'error_time')

        # Adding field 'SpeakingError.error_time_min'
        db.add_column(u'lambada_speakingerror', 'error_time_min',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SpeakingError.error_time_sec'
        db.add_column(u'lambada_speakingerror', 'error_time_sec',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SpeakingError.correction_text'
        db.add_column(u'lambada_speakingerror', 'correction_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SpeakingError.error_time'
        db.add_column(u'lambada_speakingerror', 'error_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 7, 31, 0, 0)),
                      keep_default=False)

        # Deleting field 'SpeakingError.error_time_min'
        db.delete_column(u'lambada_speakingerror', 'error_time_min')

        # Deleting field 'SpeakingError.error_time_sec'
        db.delete_column(u'lambada_speakingerror', 'error_time_sec')

        # Deleting field 'SpeakingError.correction_text'
        db.delete_column(u'lambada_speakingerror', 'correction_text')
    ...
    models = {
        ...
        u'lambada.speakingerror': {
            ...
            'error_time_min': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'error_time_sec': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'report': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['lambada.Report']"})
        },
