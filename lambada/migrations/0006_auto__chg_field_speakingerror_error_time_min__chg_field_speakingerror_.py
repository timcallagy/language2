...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SpeakingError.error_time_min'
        db.alter_column(u'lambada_speakingerror', 'error_time_min', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

        # Changing field 'SpeakingError.error_time_sec'
        db.alter_column(u'lambada_speakingerror', 'error_time_sec', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

    def backwards(self, orm):

        # Changing field 'SpeakingError.error_time_min'
        db.alter_column(u'lambada_speakingerror', 'error_time_min', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'SpeakingError.error_time_sec'
        db.alter_column(u'lambada_speakingerror', 'error_time_sec', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
