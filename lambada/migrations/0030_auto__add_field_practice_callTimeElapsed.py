...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Practice.callTimeElapsed'
        db.add_column(u'lambada_practice', 'callTimeElapsed',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Practice.callTimeElapsed'
        db.delete_column(u'lambada_practice', 'callTimeElapsed')
    ...
    models = {
        ...
        u'lambada.topic': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 29, 0, 0)'}),
