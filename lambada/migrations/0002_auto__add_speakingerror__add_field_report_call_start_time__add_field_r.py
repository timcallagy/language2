...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SpeakingError'
        db.create_table(u'lambada_speakingerror', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('report', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lambada.Report'])),
            ('error_time', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'lambada', ['SpeakingError'])

        # Adding field 'Report.call_start_time'
        db.add_column(u'lambada_report', 'call_start_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 7, 29, 0, 0)),
                      keep_default=False)

        # Adding field 'Report.call_end_time'
        db.add_column(u'lambada_report', 'call_end_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 7, 29, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'SpeakingError'
        db.delete_table(u'lambada_speakingerror')

        # Deleting field 'Report.call_start_time'
        db.delete_column(u'lambada_report', 'call_start_time')

        # Deleting field 'Report.call_end_time'
        db.delete_column(u'lambada_report', 'call_end_time')
    ...
    models = {
        ...
        u'lambada.report': {
            ...
            'call_end_time': ('django.db.models.fields.DateTimeField', [], {}),
            'call_start_time': ('django.db.models.fields.DateTimeField', [], {}),
