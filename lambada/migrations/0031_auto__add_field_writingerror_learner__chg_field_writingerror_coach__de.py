...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WritingError.learner'
        db.add_column(u'lambada_writingerror', 'learner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=5, to=orm['auth.User']),
                      keep_default=False)


        # Renaming column for 'WritingError.coach' to match new field type.
        db.rename_column(u'lambada_writingerror', 'coach_id', 'coach')
        # Changing field 'WritingError.coach'
        db.alter_column(u'lambada_writingerror', 'coach', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
        # Removing index on 'WritingError', fields ['coach']
        db.delete_index(u'lambada_writingerror', ['coach_id'])

        # Deleting field 'SpeakingError.state'
        db.delete_column(u'lambada_speakingerror', 'state')

        # Adding field 'SpeakingError.learner'
        db.add_column(u'lambada_speakingerror', 'learner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=5, to=orm['auth.User']),
                      keep_default=False)


        # Renaming column for 'SpeakingError.coach' to match new field type.
        db.rename_column(u'lambada_speakingerror', 'coach_id', 'coach')
        # Changing field 'SpeakingError.coach'
        db.alter_column(u'lambada_speakingerror', 'coach', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
        # Removing index on 'SpeakingError', fields ['coach']
        db.delete_index(u'lambada_speakingerror', ['coach_id'])


    def backwards(self, orm):
        # Adding index on 'SpeakingError', fields ['coach']
        db.create_index(u'lambada_speakingerror', ['coach_id'])

        # Adding index on 'WritingError', fields ['coach']
        db.create_index(u'lambada_writingerror', ['coach_id'])

        # Deleting field 'WritingError.learner'
        db.delete_column(u'lambada_writingerror', 'learner_id')


        # Renaming column for 'WritingError.coach' to match new field type.
        db.rename_column(u'lambada_writingerror', 'coach', 'coach_id')
        # Changing field 'WritingError.coach'
        db.alter_column(u'lambada_writingerror', 'coach_id', self.gf('django.db.models.fields.related.ForeignKey')(default='timc', to=orm['auth.User']))
        # Adding field 'SpeakingError.state'
        db.add_column(u'lambada_speakingerror', 'state',
                      self.gf('django.db.models.fields.CharField')(default='COMPLETE', max_length=8),
                      keep_default=False)

        # Deleting field 'SpeakingError.learner'
        db.delete_column(u'lambada_speakingerror', 'learner_id')


        # Renaming column for 'SpeakingError.coach' to match new field type.
        db.rename_column(u'lambada_speakingerror', 'coach', 'coach_id')
        # Changing field 'SpeakingError.coach'
        db.alter_column(u'lambada_speakingerror', 'coach_id', self.gf('django.db.models.fields.related.ForeignKey')(default='timc', to=orm['auth.User']))
    ...
    models = {
        ...
        u'lambada.topic': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 31, 0, 0)'}),
