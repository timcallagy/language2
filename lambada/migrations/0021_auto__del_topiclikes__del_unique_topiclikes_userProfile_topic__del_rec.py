...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LearnerRecording'
        db.create_table(u'lambada_learnerrecording', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('practice', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lambada.Practice'])),
            ('recording', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'lambada', ['LearnerRecording'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'LearnerRecording'
        db.delete_table(u'lambada_learnerrecording')
