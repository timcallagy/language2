...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Practice.rating'
        db.alter_column(u'lambada_practice', 'rating', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=1))

    def backwards(self, orm):

        # Changing field 'Practice.rating'
        db.alter_column(u'lambada_practice', 'rating', self.gf('django.db.models.fields.IntegerField')())
