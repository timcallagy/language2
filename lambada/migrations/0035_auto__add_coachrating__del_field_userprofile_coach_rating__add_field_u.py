...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CoachRating'
        db.create_table(u'lambada_coachrating', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('coach', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lambada.UserProfile'])),
        ...
        db.send_create_signal(u'lambada', ['CoachRating'])

        # Deleting field 'UserProfile.coach_rating'
        db.delete_column(u'lambada_userprofile', 'coach_rating')

        # Adding field 'UserProfile.total_coach_rating'
        db.add_column(u'lambada_userprofile', 'total_coach_rating',
                      self.gf('django.db.models.fields.IntegerField')(default='0'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CoachRating'
        db.delete_table(u'lambada_coachrating')

        # Adding field 'UserProfile.coach_rating'
        db.add_column(u'lambada_userprofile', 'coach_rating',
                      self.gf('django.db.models.fields.IntegerField')(default='0'),
                      keep_default=False)

        # Deleting field 'UserProfile.total_coach_rating'
        db.delete_column(u'lambada_userprofile', 'total_coach_rating')
    ...
    models = {
        ...
        u'lambada.practice': {
            ...
            'rating': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '7', 'decimal_places': '1'}),
