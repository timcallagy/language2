...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Practice.dateTimeNew'
        db.delete_column(u'lambada_practice', 'dateTimeNew')

        # Adding field 'Practice.dateTime'
        db.add_column(u'lambada_practice', 'dateTime',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 6, 21, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Practice.dateTimeNew'
        db.add_column(u'lambada_practice', 'dateTimeNew',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 6, 21, 0, 0)),
                      keep_default=False)

        # Deleting field 'Practice.dateTime'
        db.delete_column(u'lambada_practice', 'dateTime')
    ...
    models = {
        ...
        u'lambada.topic': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 21, 0, 0)'}),
