...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.skype_addr'
        db.delete_column(u'lambada_userprofile', 'skype_addr')
    ...
    def backwards(self, orm):
        # Adding field 'UserProfile.skype_addr'
        db.add_column(u'lambada_userprofile', 'skype_addr',
    ...
    models = {
        ...
        u'lambada.userprofile': {
            ...
            'coach_rating': ('django.db.models.fields.IntegerField', [], {'default': "'0'"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.CharField', [], {'default': "'en'", 'max_length': '255'}),
