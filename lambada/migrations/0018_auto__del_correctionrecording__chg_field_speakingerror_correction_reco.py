...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'CorrectionRecording'
        db.delete_table(u'lambada_correctionrecording')


        # Changing field 'SpeakingError.correction_recording'
        db.alter_column(u'lambada_speakingerror', 'correction_recording', self.gf('django.db.models.fields.files.FileField')(max_length=100))

    def backwards(self, orm):
        # Adding model 'CorrectionRecording'
        db.create_table(u'lambada_correctionrecording', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('error', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lambada.SpeakingError'])),
            ('correctionRec', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal(u'lambada', ['CorrectionRecording'])


        # Changing field 'SpeakingError.correction_recording'
        db.alter_column(u'lambada_speakingerror', 'correction_recording', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'lambada.speakingerror': {
            ...
            'correction_recording': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
        ...
        u'lambada.topic': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 23, 0, 0)'}),
