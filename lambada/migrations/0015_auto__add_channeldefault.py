...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ChannelDefault'
        db.create_table(u'lambada_channeldefault', (
        ...
        db.send_create_signal(u'lambada', ['ChannelDefault'])


    def backwards(self, orm):
        # Deleting model 'ChannelDefault'
        db.delete_table(u'lambada_channeldefault')
    ...
    models = {
        ...
        u'lambada.topic': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 10, 0, 0)'}),
