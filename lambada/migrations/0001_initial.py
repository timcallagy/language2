...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'lambada_topic', (
            ...
            ('language', self.gf('django.db.models.fields.CharField')(default='en', max_length=255)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 6, 21, 0, 0))),
        ...
        db.create_table(u'lambada_practice', (
            ...
            ('dateTimeNew', self.gf('django.db.models.fields.DateTimeField')()),
        ))
    ...
    models = {
        ...
        u'lambada.practice': {
            ...
            'dateTimeNew': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
