...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpeakingError.correction_recording'
        db.add_column(u'lambada_speakingerror', 'correction_recording',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SpeakingError.correction_recording'
        db.delete_column(u'lambada_speakingerror', 'correction_recording')
