...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SpeakingError.report'
        db.delete_column(u'lambada_speakingerror', 'report_id')

        # Adding field 'SpeakingError.practice'
        db.add_column(u'lambada_speakingerror', 'practice',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=13, to=orm['lambada.Practice']),
                      keep_default=False)

        # Adding field 'SpeakingError.learnerRecording'
        db.add_column(u'lambada_speakingerror', 'learnerRecording',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['lambada.LearnerRecording']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SpeakingError.report'
        db.add_column(u'lambada_speakingerror', 'report',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=5, to=orm['lambada.Report']),
                      keep_default=False)

        # Deleting field 'SpeakingError.practice'
        db.delete_column(u'lambada_speakingerror', 'practice_id')

        # Deleting field 'SpeakingError.learnerRecording'
        db.delete_column(u'lambada_speakingerror', 'learnerRecording_id')
