...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'WritingError.report'
        db.delete_column(u'lambada_writingerror', 'report_id')

        # Adding field 'WritingError.practice'
        db.add_column(u'lambada_writingerror', 'practice',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=5, to=orm['lambada.Practice']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'lambada_report', (
            ...
            ('call_start_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('call_end_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'lambada', ['Report'])

        # Adding field 'WritingError.report'
        db.add_column(u'lambada_writingerror', 'report',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=5, to=orm['lambada.Report']),
                      keep_default=False)

        # Deleting field 'WritingError.practice'
        db.delete_column(u'lambada_writingerror', 'practice_id')
    ...
    models = {
        ...
        u'lambada.topic': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 27, 0, 0)'}),
