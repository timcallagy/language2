...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TopicRating.practice'
        db.delete_column(u'lambada_topicrating', 'practice_id')

        # Adding field 'Topic.total_topic_rating'
        db.add_column(u'lambada_topic', 'total_topic_rating',
                      self.gf('django.db.models.fields.IntegerField')(default='0'),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TopicRating.practice'
        db.add_column(u'lambada_topicrating', 'practice',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2014, 9, 15, 0, 0), to=orm['lambada.Practice']),
                      keep_default=False)

        # Deleting field 'Topic.total_topic_rating'
        db.delete_column(u'lambada_topic', 'total_topic_rating')
