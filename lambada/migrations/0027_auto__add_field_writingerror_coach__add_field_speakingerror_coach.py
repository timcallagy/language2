...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WritingError.coach'
        db.add_column(u'lambada_writingerror', 'coach',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=6, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'SpeakingError.coach'
        db.add_column(u'lambada_speakingerror', 'coach',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=6, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WritingError.coach'
        db.delete_column(u'lambada_writingerror', 'coach_id')

        # Deleting field 'SpeakingError.coach'
        db.delete_column(u'lambada_speakingerror', 'coach_id')
