...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WritingError'
        db.create_table(u'lambada_writingerror', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('report', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lambada.Report'])),
            ('original_text', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True)),
            ('correction_text', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'lambada', ['WritingError'])


    def backwards(self, orm):
        # Deleting model 'WritingError'
        db.delete_table(u'lambada_writingerror')
