...
//////        var Recorder = IsChrome ? window.StereoRecorder : window.MediaStreamRecorder;
	var Recorder = window.MediaStreamRecorder;
    ...
    function getDataURL(callback, _mediaRecorder) {
        ...
        console.warn('In processInWebWorker.');
            return worker;
        }
    }
    ...
    return {
        ...
        save: function () {
            ...
            console.warn('In Save function 5');
                hyperlink.dispatchEvent(evt);

            console.warn('In Save function 6');
                (window.URL || window.webkitURL).revokeObjectURL(hyperlink.href);
            console.warn('In Save function 7');
            });
        },
